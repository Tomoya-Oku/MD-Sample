...
def main():
    ...
    input_pos_VVL = pd.read_table("posvel_VVL.dat",header=None, delim_whitespace=True)
    ...
    posx_VVL = input_pos_VVL[input_pos_VVL.keys()[1]]
    posy_VVL = input_pos_VVL[input_pos_VVL.keys()[2]]
    posz_VVL = input_pos_VVL[input_pos_VVL.keys()[3]]
    ...
    plt.plot(time, posx_VVL, label="posx(VVL)", color="red", linestyle="dotted")
